...
function getStateOfChat() {
	if (!instanse) {
		...
		$.ajax({
			...
			crossDomain: true,
			cache: false,
			url: "https://www.dfunstation.com/api4/consultant/index.php/member/chatkonsultan-con/" + chatid + "/" + localStorage.userid + "/?callback=?",
...
function updateChatx() {
	...
	if (!instanse) {
		...
		$.ajax({
			...
			crossDomain: true,
			cache: false,
			url: "https://www.dfunstation.com/api4/consultant/index.php/member/chatkonsultan-con/" + chatid + "/" + localStorage.userid + "/" + localStorage.lastchatid + "/?callback=?",
